execute store result score .filled aa.local run fill ^-1 ^ ^2 ^1 ^ ^-1 minecraft:air replace #minecraft:crops
...
execute store result score .filled aa.local run fill ^-1 ^ ^2 ^1 ^ ^-1 minecraft:air replace #minecraft:gourds
