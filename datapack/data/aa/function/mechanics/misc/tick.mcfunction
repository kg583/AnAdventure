...
execute as @e[type=minecraft:arrow,tag=!aa.lingered] if predicate c:entity/in_ground if data entity @s item.components."minecraft:potion_contents" at @s run function aa:mechanics/misc/tipped_arrows
