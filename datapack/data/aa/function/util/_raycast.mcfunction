...
# Callback after cast
execute if block ~ ~ ~ #aa:raycast_transparent positioned ~ ~-0.5 ~ unless entity @n[type=!minecraft:player,distance=..1.5] positioned ~ ~0.5 ~ positioned ^ ^ ^0.2 run return run function aa:util/_raycast with storage aa:io
