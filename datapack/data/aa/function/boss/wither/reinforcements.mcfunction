...
execute at @a[distance=..32] positioned ~ ~ ~-1 summon minecraft:wither_skeleton run tag @s add aa.wither_reinforcement
execute if score #difficulty aa.const matches 2.. at @a[distance=..32] positioned ~1 ~ ~ summon minecraft:wither_skeleton run tag @s add aa.wither_reinforcement
execute if score #difficulty aa.const matches 3.. at @a[distance=..32] positioned ~-1 ~ ~ summon minecraft:wither_skeleton run tag @s add aa.wither_reinforcement
