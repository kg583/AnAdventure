...
summon minecraft:marker ~ ~ ~ {Tags:["aa.spawn.yearn_iron_golem","smithed.entity","smithed.strict"]}
spreadplayers ~ ~ 2 8 true @e[type=minecraft:marker,tag=aa.spawn.yearn_iron_golem]
execute at @e[type=minecraft:marker,tag=aa.spawn.yearn_iron_golem] run summon minecraft:iron_golem
kill @e[type=minecraft:marker,tag=aa.spawn.yearn_iron_golem]
