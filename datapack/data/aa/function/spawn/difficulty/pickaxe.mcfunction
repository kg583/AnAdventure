...
execute if score #pickaxe aa.rand matches 2 unless items entity @s armor.head * run item replace entity @s armor.head with minecraft:iron_helmet
execute if score #pickaxe aa.rand matches 3 unless items entity @s armor.head * run item replace entity @s armor.head with minecraft:golden_helmet
