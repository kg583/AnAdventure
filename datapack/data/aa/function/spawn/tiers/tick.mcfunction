...
execute if score #daytime aa.const matches 2000..12000 as @e[type=minecraft:creeper] at @s if predicate c:can_see_sky unless predicate c:biome/is_dark_forest unless data entity @s CustomName run function aa:spawn/tiers/aw_man
