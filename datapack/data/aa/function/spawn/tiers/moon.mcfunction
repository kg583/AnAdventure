...
execute if entity @s[type=minecraft:zombie,predicate=c:entity/is_baby] unless entity @e[type=minecraft:skeleton,distance=..12] summon minecraft:wolf run ride @n[type=minecraft:zombie,distance=..1] mount @s
