...
# Tiers
execute as @e[tag=aa.spiderling,distance=..2] at @s if entity @s[y=32,dy=95] unless predicate c:can_see_sky run function aa:spawn/tiers/spiderling/1
execute as @e[tag=aa.spiderling,distance=..2] at @s if entity @s[y=0,dy=31] unless predicate c:can_see_sky run function aa:spawn/tiers/spiderling/2
execute as @e[tag=aa.spiderling,distance=..2] at @s if entity @s[y=-64,dy=63] unless predicate c:can_see_sky run function aa:spawn/tiers/spiderling/3
