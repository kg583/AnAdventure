...
# Add failsafes
execute unless data storage aa:story villagers.any[0] run data modify storage aa:story villagers.any append value [{name:"Jon",profession:"minecraft:none",level:1,type:"minecraft:plains",translation:{profession:"entity.minecraft.villager"}}]
execute unless data storage aa:story villagers.employed[0] run data modify storage aa:story villagers.employed append value [{name:"Jon",profession:"minecraft:farmer",level:1,type:"minecraft:plains",translation:{profession:"entity.minecraft.villager.farmer"}}]
