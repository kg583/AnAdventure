execute unless entity @n[type=minecraft:marker,tag=aa.stronghold,distance=..1] run summon minecraft:marker ~ ~ ~ {Tags:["aa.stronghold","smithed.entity","smithed.strict"]}
execute positioned ~-2.5 ~0.4 ~-2.5 unless entity @n[type=minecraft:item_display,tag=aa.stronghold,distance=..1] run summon minecraft:item_display ~ ~ ~ {Tags:["aa.stronghold","smithed.entity","smithed.strict"]}
