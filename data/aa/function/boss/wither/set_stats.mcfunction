...
execute if score #difficulty aa.const matches ..1 run scoreboard players set @s aa.phase 1
execute if score #difficulty aa.const matches 2 run scoreboard players set @s aa.phase 2
execute if score #difficulty aa.const matches 3.. run scoreboard players set @s aa.phase 3
